...
// Glyphs by registry icon name (Simple Icons, CC0, same set as the website's
// ShareIcon.astro). A name not listed here gets the generic share symbol, so a
// new registry entry never needs a code change to render.
const ICONS = {
  native: '<path d="M15.75 4.5a3 3 0 1 1 .825 2.066l-8.421 4.679a3.002 3.002 0 0 1 0 1.51l8.421 4.679a3 3 0 1 1-.729 1.31l-8.421-4.678a3 3 0 1 1 0-4.132l8.421-4.679a3 3 0 0 1-.096-.744Z"/>',
  ...
  reddit: '<path d="M24 11.779c0-1.459-1.192-2.645-2.657-2.645-.715 0-1.363.286-1.84.746-1.81-1.191-4.259-1.949-6.971-2.046l1.483-4.669 4.016.941-.006.058c0 1.193.975 2.163 2.174 2.163 1.198 0 2.172-.97 2.172-2.163s-.975-2.164-2.172-2.164c-.92 0-1.704.574-2.021 1.379l-4.329-1.015c-.189-.046-.381.063-.44.249l-1.654 5.207c-2.759.076-5.245.83-7.083 2.032-.474-.438-1.103-.712-1.798-.712-1.465 0-2.657 1.187-2.657 2.646 0 1.061.629 1.976 1.531 2.393-.041.259-.062.523-.062.79 0 3.991 4.539 7.239 10.117 7.239s10.116-3.248 10.116-7.239c0-.269-.021-.533-.063-.792.899-.418 1.526-1.331 1.526-2.391zM6.831 14.393c0-.832.679-1.508 1.515-1.508.833 0 1.511.676 1.511 1.508s-.678 1.512-1.511 1.512c-.836.001-1.515-.68-1.515-1.512zm8.05 4.702c-.708.707-1.696.949-2.892.949h-.002c-1.195 0-2.184-.242-2.892-.949-.129-.129-.129-.339 0-.468.129-.13.34-.13.469 0 .541.541 1.353.735 2.423.735h.002c1.07 0 1.882-.194 2.423-.735.129-.13.34-.13.469 0 .129.129.129.339 0 .468zm-.29-3.191c-.836 0-1.515-.68-1.515-1.512s.679-1.508 1.515-1.508c.833 0 1.511.676 1.511 1.508s-.678 1.512-1.511 1.512z"/>',
