export namespace main {
	...
	export class ZoneTemplateMember {
	    deviceID: string;
	    ip: string;
	
	    static createFrom(source: any = {}) {
	        return new ZoneTemplateMember(source);
	    }
	...
	export class ZoneTemplate {
	    id: string;
	    name: string;
	    master: ZoneTemplateMember;
	    members: ZoneTemplateMember[];
	    permanent: boolean;
	
	    static createFrom(source: any = {}) {
	        return new ZoneTemplate(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.id = source["id"];
	        this.name = source["name"];
	        this.master = this.convertValues(source["master"], ZoneTemplateMember);
	        this.members = this.convertValues(source["members"], ZoneTemplateMember);
