...
func (s *Server) handleZoneForm(w http.ResponseWriter, r *http.Request) {
	...
	// The same correction for the SLAVES, for the same reason and from the
	// same evidence; the full story lives on correctZoneMemberIDs.
	...
	// Everything from the coalescer down lives in driveZone (zonedrive.go), so
